...
public class Yoga extends JFrame { 
    ...
    Yoga() 
    {
        ...
        li1.addElement("Stress Relief"); 
        li1.addElement("Back Pain"); 
        li1.addElement("Insomnia"); 
        li1.addElement("Obesity"); 
        li1.addElement("Blood Pressure"); 
        ...
        li2.addElement( 
            "Attend(Sat & Sun)"); 
        li2.addElement( 
            "Attend(Twice in week)"); 
        li2.addElement( 
            "Attend(Twice in month)"); 
        li2.addElement( 
            "Attend(Depends)"); 
